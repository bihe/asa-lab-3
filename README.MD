...
The [eShop](https://github.com/dotnet/eShop) application demonstrates a best-practice approach for ASP.NET applications by implementing a sample shop/e-commerce solution.
